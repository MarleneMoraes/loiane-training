 ...
 * escaleno. 
 * 		Dicas:
 * 		- Três lados formam um triângulo quando a soma de quaisquer dos 
...
public class Ex015 {
	...
	public static void main(String[] args) {
		...
		} else if (lado[0] == lado[1] && lado[1] != lado[2] || lado[0] != lado[1] && lado[1] == lado[2] || lado[0] == lado[2] && lado[1] != lado[2]) {
